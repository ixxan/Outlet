...
<body>
    ...
    <div id="wrapper" style = "padding-top: 40px" >
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style = "padding-top: 40px ">Giveaways</h1>
                </div>
                ...
                if(isset($_GET["giveawayId"]))
                {
                    ...
                    $getGiveaway = "SELECT * FROM giveawayList WHERE id ='$giveawayId'";
                    ...
                    while($rowGiveaway = mysqli_fetch_array($runGiveaway))
                    {
                        ...
                        echo" 
                            <div id='single_giveaway_detail'> 
                                ...
                                <p name='report_button'><a href='report.php?giveawayId=$giveawayId'><button> Report </button></a></p>
                                <p name='giveaway-name'>$giveawayName</p>
                                <image src= '/Project/pages/UserUploads/GiveawayPictures/$giveawayPictureName'/>
                                <div name='giveaway-info'>
                                    <h4>Info:</h4>
                                    <p>$giveawayInfo</P> 
                                </div>
                            </div>
