...
<body>
    ...
    <div id="wrapper" style = "padding-top: 40px" >
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style = "padding-top: 40px ">Report</h1>
                </div>
                <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <p style="font-size:16px; font-weight:440">Please tell us what's happening:</p>
                        </div>
                        ...
                        <?php
                         if(isset($_GET['productId']))
                         {
                            ...
                            $reportCategoryId = $_GET["productId"];
                            echo "<form action='/Project/pages/UserUploads/report_upload.php?category=$reportCategory&id=$reportCategoryId' method='post' enctype='multipart/form-data'>";
                         }
                         if(isset($_GET['serviceId']))
                         {
                            $reportCategory = "Service";
                            $reportCategoryId = $_GET["serviceId"];
                            echo "<form action='/Project/pages/UserUploads/report_upload.php?category=$reportCategory&id=$reportCategoryId' method='post' enctype='multipart/form-data'>";
                         }
                         if(isset($_GET["couponId"]))
                        {
                            $reportCategory = "Coupon";
                            $reportCategoryId = $_GET["couponId"];
                            echo "<form action='/Project/pages/UserUploads/report_upload.php?category=$reportCategory&id=$reportCategoryId' method='post' enctype='multipart/form-data'>";
                        }
                        if(isset($_GET["giveawayId"]))
                        {
                            $reportCategory = "Giveaway";
                            $reportCategoryId = $_GET["giveawayId"];
                            echo "<form action='/Project/pages/UserUploads/report_upload.php?category=$reportCategory&id=$reportCategoryId' method='post' enctype='multipart/form-data'>";
                        }
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="report-message" placeholder="Enter your message" rows="3" required></textarea>
                                </div>
                                <button type="submit" name="report-submit-button" class="btn btn-primary">Submit</button>
                                <?php
                                    if($_GET["report"] == "success")
                                    {
                                        echo "<script> alert('Report succeed! Thank you!')</script>";
                                    }
                                    
                                ?>
                                </form>
                                
                            <button onclick="history.back()" name="report-cancel-button" class="btn btn-default">Cancel</button>
