        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div  style = "padding: 10px">
                    <a href='/Project/pages/coupons.php' style="text-decoration: none">
                        <button type="button" class="btn btn-default btn-circle "><p>All</p></button>
                    </a>
                    |
                    <a href='/Project/pages/food_coupon.php' title="Food" style="background-color:#FFFFFF;color:#000000;text-decoration:none">
                        <button type="button" class="btn btn-default btn-circle "><i class="fa fa-cutlery"></i></button>
                    </a>
                    <a href='/Project/pages/clothingshoes_coupon.php' title="Clothing & Shoes" style="background-color:#FFFFFF;color:#000000;text-decoration:none">
                        <button type="button" class="btn btn-primary btn-circle "><i class="glyphicon glyphicon-sunglasses"></i></button>
                    </a>
                    <a href='/Project/pages/entertainment_coupon.php' title="Entertainment" style="background-color:#FFFFFF;color:#000000;text-decoration:none">
                        <button type="button" class="btn btn-default btn-circle "><i class="fa fa-gamepad"></i></button>
                    </a>
                    <a href='/Project/pages/grocery_coupon.php' title="Grocery" style="background-color:#FFFFFF;color:#000000;text-decoration:none">
                        <button type="button" class="btn btn-default btn-circle "><i class="fa fa-shopping-cart"></i></button>
                    </a>
                </div>
