...
<body>
    ...
    <div id="wrapper" style = "padding-top: 40px" >
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style = "padding-top: 40px ">Services</h1>
                </div>
                ...
                if(isset($_GET["serviceId"]))
                {
                    ...
                    $getService = "SELECT * FROM serviceList WHERE id ='$serviceId'";
                    ...
                    while($rowService = mysqli_fetch_array($runService))
                    {
                        ...
                        echo" 
                            <div id='single_service_detail'> 
                                ...
                                <p name='report_button'><a href='report.php?serviceId=$serviceId'><button> Report </button></a></p>
                                <p name='service-name'>$serviceName</p>
                                <p name='service-chargeRate'>$serviceChargeRate</p>
                                <div name='service-info'>
                                    <h4>Info:</h4>
                                    <p>$serviceInfo</P> 
                                </div>
                            </div>
