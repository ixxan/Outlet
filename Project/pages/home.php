...
<body>
    ...
    <div id="wrapper" style = "padding-top: 40px" >
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style = "padding-top: 40px ">Home</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="huge" style = "padding: 10px; text-align:center ;">
                        ...
                        <a href="/Project/pages/products.php">
                            <div class="panel-footer">
                                <span class="pull-left" style = "padding: 5px;">Go to Products</span>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="panel panel-green">
                        ...
                        <a href="/Project/pages/services.php">
                            <div class="panel-footer">
                                <span class="pull-right" style = "padding: 5px;">Go to Services</span>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="panel panel-yellow">
                        <a href="/Project/pages/coupons.php">
                            <div class="panel-heading">
                                <span class="pull-left" style = "padding: 5px;">Go to Coupons</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right fa-2x"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <div class="panel-footer" style = "color:white; background-color: #f0ad4e" >
                            <div class="row">
                                <div class="huge" style = "padding: 10px; text-align:center ;">
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="panel panel-red">
                        <a href="/Project/pages/giveaways.php">
                            <div class="panel-heading">
                                <span class="pull-right" style = "padding: 5px;">Go to Giveaways</span>
                                <span class="pull-left"><i class="fa fa-arrow-circle-left fa-2x"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <div class="panel-footer" style = "color:white; background-color: #d9534f" >
                            <div class="row">
                                <div class="huge" style = "padding: 10px; text-align:center ;">
