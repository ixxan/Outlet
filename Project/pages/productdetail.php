        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                if(isset($_GET["productId"]))
                {
                    ...
                    $getProduct = "SELECT * FROM productList WHERE id ='$productId'";
                    ...
                    while($rowProduct = mysqli_fetch_array($runProduct))
                    {
                        ...
                        $productPurchaseMethod = $rowProduct['purchaseMethod'];
                        $productPrice = $rowProduct['price'];
                        $productPictureName = $rowProduct['pictureName'];
                        
                        //verify Purchase Method if it's a url
                        if(filter_var($productPurchaseMethod, FILTER_VALIDATE_URL))
                        {
                            $productPurchaseLink = "<a href='$productPurchaseMethod'><button type='button' class='btn btn-primary'>Go To Purchase</button></a>";
                            ...
                            <div id='single_product_detail'> 
                                ...
                                <p name='report_button'><a href='report.php?productId=$productId'><button> Report </button></a></p>
                                <p name='product-name'>$productName</p>
                                <image src= '/Project/pages/UserUploads/ProductPictures/$productPictureName'/>
                                <p name='product-price'>$$productPrice</p>
                                <div name='product-detail'>
                                <div class= 'info'>
                                    <h4>Product Description:</h4>
                                    <p>$productDescription</P> 
                                </div>
                                <div  class= 'info'>
                                    <h4>Purcahse Method:</h4>
                                    <p>$productPurchaseLink</P> 
                                </div>
                                </div>
                            </div>
                            ";
                ...
                else
                {
                   ...
                   <p style = 'padding-left: 20px' name='goback-button' >
                        <a href='/Project/pages/products.php'>
